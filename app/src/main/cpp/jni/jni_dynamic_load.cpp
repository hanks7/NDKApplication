...
#define JAVA_CLASS "com/easyway/ndkapplication/load/JNIDynamicLoad"
...
static int registerNatives(JNIEnv *env) {
    const char *className = "com/easyway/ndkapplication/load/JNIDynamicLoad";

    return registerNativeMethods(env, className, getMethods, 2);
}
